CLASS zcl_rap100_gen_data_44 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_rap100_gen_data_44 IMPLEMENTATION.

  METHOD if_oo_adt_classrun~main.

    DATA:
      group_id   TYPE string VALUE '44',
      attachment TYPE /dmo/attachment,
      file_name  TYPE /dmo/filename,
      mime_type  TYPE /dmo/mime_type.

*Clear data
    DELETE FROM zrap100_atrav44.

    "insert travel demo data
    INSERT zrap100_atrav44 FROM (
    SELECT
